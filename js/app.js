(() => {
    ...
    function initSliders() {
        if (document.querySelector(".menu-slider__slider")) {
            let windowWidth = window.innerWidth;
            if (windowWidth >= 768) new swiper_core_Swiper(".menu-slider__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 4,
        ...
        if (document.querySelector(".gallery__slider")) {
            let windowWidth = window.innerWidth;
            if (windowWidth <= 768) new swiper_core_Swiper(".gallery__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
